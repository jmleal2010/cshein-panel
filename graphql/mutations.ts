...
export const SEND_EMAIL_CONFIRMATION_MUTATION = gql`
  mutation SendEmailConfirmationCode($email: String!) {
...
export const VERIFICATION_CODE_MUTATION = gql`
  mutation VerifyEmailConfirmationCode($email: String!, $code: String!) {
