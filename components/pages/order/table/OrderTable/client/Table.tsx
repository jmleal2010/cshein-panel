...
export default function Table({
  ...
  const hidePopover = () => {
    if (popoverRef.current) {
      popoverRef.current.classList.remove("aparecer");
      popoverRef.current.classList.add("desaparecer");
    }
  };
  const showPopover = () => {
    if (popoverRef.current) {
          popoverRef.current.classList.remove("desaparecer");
          popoverRef.current.classList.add("aparecer");
    }
  };
