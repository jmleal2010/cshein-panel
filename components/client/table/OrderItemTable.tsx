    ...
    <React.Fragment>
      ...
      >
        ...
        >
          <thead>
            <tr>
              <th style={{ width: 120, padding: "12px 6px" }}>Ver producto</th>
                  ...
                  <td>
                    ...
                    >
                      <Avatar
                        ...
                        width={60}
                        height={60}
                        className="cshein-avatar"
                      />
                      <Link href={row.link}>
                        {" "}
                        <Typography variant="caption">Ver producto</Typography>
                      </Link>
                    </div>
                  </td>
                  <td>
