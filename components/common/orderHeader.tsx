            ...
            <Stack direction="row" alignItems="center" spacing={2} className="MuiStack-root css-13xiveh">
                ...
                <Stack direction="column" alignItems="flex-start" spacing={1} className="MuiStack-root css-1kkt86i">
                    <Stack direction="row" alignItems="center" spacing={1} className="MuiStack-root css-hp68mp">
                        <Typography variant="h6" className="MuiTypography-root MuiTypography-h4 css-sko12q">Order
                            #{order.code}</Typography>
                        <Box className="MuiBox-root css-1r7dlkq"><Chip color="primary" label={order.status} /></Box>
                    </Stack>
                    <Typography sx={{marginTop:' 0 !important'}} variant="subtitle2" className="MuiTypography-root MuiTypography-body2 css-j1x1ao">{moment(order.createdAt).format('YYYY-MM-DD HH:mm:ss')}</Typography>
                </Stack>
            </Stack>
